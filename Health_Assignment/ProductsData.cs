...
namespace Health_Assignment
{
    public class ProductsData
    {
        ...
        public static List<Product> initializeData()
        {
            ...
            products.Add(new Protein("Ultra Potency Gymnema Sylvestre", "Source Naturals Ultra Potency Gymnema Sylvestre provides powerful support to help maintain healthy blood sugar levels when used as part of your diet. This herb has been used traditionally in India for centuries and has been shown in research to support healthy glucose metabolism by mediation of insulin release and activity and enhancement of healthy pancreatic function. Ultra Potency Gymnema Sylvestre is standardized to 75% gymnemic acids for potent metabolic support. It also contains 50 mg gymnema leaf 5:1 extract.", "1 tablet daily with a meal", "Source Naturals", 102.80M, 30));
