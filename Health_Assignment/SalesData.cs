...
namespace Health_Assignment
{
    public class SalesData
    {
        ...
        {
            sales.Add(new Sales(CustomersData.customers[2], true, "Delivered", "Cash", new List<Product>(new Product[] { ProductsData.products[0], ProductsData.products[1] } ), new List<int>(new int[] { 1, 2, 3 }), new DateTime(2017, 1, 21), new DateTime(2017, 11, 12)));
